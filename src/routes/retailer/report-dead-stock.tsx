...
/** Dead stock — stuck units per variant (SKU), oldest-sale first. */
export function DeadStockPanel({ controls, collapsed, onCount }: ReportShellProps = {}) {
  ...
  return (
    <Page>
      <PageHeader
        kicker="Analytics"
        title="Dead stock"
        description="Variants (SKUs) with stock but no sales in the threshold window. Mark down or retire."
      />
      <DeadStockPanel />
    </Page>
  );
